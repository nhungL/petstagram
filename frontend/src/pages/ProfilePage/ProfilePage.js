                    ...
                    <Grid item sm={12} md={3} className={classes.item}>
                        <div>
                            ...
                            <Typography className={classes.subtitle} align="left">
                                Tell others more about you. (nickname, hobbies, age, location, etc.)
                            </Typography>
                            <Typography className={classes.subtitle} align="left">
                                Join since ...
                            </Typography>
                            ...
                            <Typography sx={{ marginLeft: "20px" }}>
                                <Typography className={classes.introdata} align="left" marginBottom="10px">
                                ...
                                <Typography className={classes.introdata} align="left" marginBottom="10px">
                                    ...
                                    <span >Following</span>
                                    <Typography className={classes.introdata}>#following</Typography>
                                </Typography>

                                <Typography className={classes.introdata} align="left" marginBottom="10px">
                                    <CircleIcon className={classes.circleicon} sx={{ color: "green" }} />
                                    <span>Followers</span>
                                    <Typography className={classes.introdata}>#followers</Typography>
                                </Typography>
